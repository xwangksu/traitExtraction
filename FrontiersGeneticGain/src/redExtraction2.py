...
finalFile = open(targetPath+"\\RED_ByPlot_1.csv", 'wt')
#------------------------------------------------------------------------
...
#             plt.show()
            ...
            writer.writerow((plotID,imageFileName.replace("_R.tif","_1.tif"),'{:.3f}'.format(meanFlat),'{:.3f}'.format(modeFlat),np.count_nonzero(imNpArray)))
