...
try:
    ...
    for im in imList:
        ...
        imElement = imFileName.split("-2019")
        ...
        rangeNum = pElement[1]
        columNum = pElement[2]
        imageFileName = '2019'+imElement[numOfImElement-1]
...
#             plt.show()
            ...
            writer.writerow((plotID,rangeNum,columNum,imageFileName.replace("_RE.tif","_1.tif"),'{:.3f}'.format(meanFlat),'{:.3f}'.format(modeFlat),np.count_nonzero(imNpArray)))
