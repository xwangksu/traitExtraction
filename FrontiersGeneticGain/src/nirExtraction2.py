...
finalFile = open(targetPath+"\\NIR_ByPlot_1.csv", 'wt')
#------------------------------------------------------------------------
...
#             plt.show()
            ...
            writer.writerow((plotID,imageFileName.replace("_NIR.tif","_1.tif"),'{:.3f}'.format(meanFlat),'{:.3f}'.format(modeFlat),np.count_nonzero(imNpArray)))
