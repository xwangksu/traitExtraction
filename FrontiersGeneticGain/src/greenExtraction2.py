...
finalFile = open(targetPath+"\\GREEN_ByPlot_1.csv", 'wt')
#------------------------------------------------------------------------
...
#             plt.show()
            ...
            writer.writerow((plotID,imageFileName.replace("_G.tif","_1.tif"),'{:.3f}'.format(meanFlat),'{:.3f}'.format(modeFlat),np.count_nonzero(imNpArray)))
